export enum ActionTypes  {
  ...
  GET_DATA_FOR_DETAILS_ITEM = 'GET_DATA_FOR_DETAILS_ITEM',
  GET_DATA_FOR_DETAILS_ITEM_SUCCESS = 'GET_DATA_FOR_DETAILS_ITEM_SUCCESS',
  GET_DATA_FOR_DETAILS_ITEM_FAILURE = 'GET_DATA_FOR_DETAILS_ITEM_FAILURE'
}
